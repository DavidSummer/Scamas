...
/**
  ...
  */
class Move
case class Inform(whitePages: Map[String,ActorRef]) extends Move// inform the agent about their social environment
case object AcknowledgeInform extends Move
